...
export type PostMessageEvent = MatchClickEvent | MatchJumpEvent | MatchSelectEvent | MatchWarnEvent | ConversationSelectEvent;
...
export interface ConversationSelectEvent extends BasePostMessageEvent {
